        ...
        <div className="upsell-fade grid grid-cols-1 md:grid-cols-2 gap-4 mb-10" style={{ animationDelay: '0.15s' }}>
          <div className="bg-red-50 border border-red-200 rounded-2xl p-5">
            ...
            <ul className="space-y-2.5 text-sm text-gray-700">
              ...
              <li className="flex items-start gap-2"><span className="text-red-400 shrink-0 mt-0.5">•</span>Can only charge GH₵2,000–GH₵5,000 per project</li>
            </ul>
          </div>
          <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5">
            ...
            <ul className="space-y-2.5 text-sm text-gray-700">
              ...
              <li className="flex items-start gap-2"><span className="text-emerald-400 shrink-0 mt-0.5">•</span>Charge GH₵10,000–GH₵20,000+ per project</li>
            </ul>
          </div>
        </div>
