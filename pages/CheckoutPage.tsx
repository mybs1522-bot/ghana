        ...
        <div className="px-6 pt-5 pb-6">
          ...
          <button
            ...
            onClick={() => {
              ...
              const selarUrl = `https://selar.com/8w97ef6b6h?quickcheckout=1&email=${encodeURIComponent(email)}&fullname=${encodeURIComponent(fullName.trim())}&currency=GHS&redirect_url=${encodeURIComponent(redirectUrl)}`;
